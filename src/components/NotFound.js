  ...
  render() {
      if (this.state.redirect) {
        ...
        return(
          ...
          <Typography variant='h3' style={{paddingTop: 100, paddingBottom: 100, color: 'white'}}> 404 Page Not Found</Typography> 
        
                      <Grid container spacing={24} >
                        <Grid item xs={6}> 
                          <Typography variant='h4'  style={{paddingTop: 50, color: 'white'}} > No Music to be found here  </Typography> 
                          <Typography variant='h5' style={{paddingTop: 100, color: 'white'}}> Find your way back to good music  </Typography> 
